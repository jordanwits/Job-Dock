...
const PENDING_MIGRATIONS = [
  ...
  {
    name: '20260213114908_add_job_assignment_pricing',
    statements: [
...
WHERE "assignedTo" IS NOT NULL
  ...
  {
    name: '20260214123415_add_time_entry_user_id',
    statements: [
      `ALTER TABLE "time_entries" ADD COLUMN IF NOT EXISTS "userId" TEXT;`,
  ...
  {
    name: '20260318000000_add_independent_bookings',
    statements: [
...
END $$`,
  ...
  {
    name: '20250408120000_add_saved_line_items',
    statements: [
      ...
      `CREATE UNIQUE INDEX IF NOT EXISTS "saved_line_items_tenantId_normalizedName_key" ON "saved_line_items"("tenantId", "normalizedName")`,
      `CREATE INDEX IF NOT EXISTS "saved_line_items_tenantId_idx" ON "saved_line_items"("tenantId")`,
      `CREATE INDEX IF NOT EXISTS "saved_line_items_tenantId_isActive_idx" ON "saved_line_items"("tenantId", "isActive")`,
      `DO $$
      BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'saved_line_items_tenantId_fkey') THEN
          ALTER TABLE "saved_line_items" ADD CONSTRAINT "saved_line_items_tenantId_fkey"
            FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
        END IF;
      END $$`,
    ],
    description: 'Tenant catalog of saved line items for quotes and invoices',
  },
  {
    name: '20260506120000_help_chat_rag',
    statements: [
      ...
      `CREATE UNIQUE INDEX IF NOT EXISTS "help_knowledge_chunks_source_chunk_index_key" ON "help_knowledge_chunks"("source", "chunk_index")`,
      `CREATE INDEX IF NOT EXISTS "help_knowledge_chunks_source_idx" ON "help_knowledge_chunks"("source")`,
      `CREATE INDEX IF NOT EXISTS "help_chat_sessions_tenant_id_idx" ON "help_chat_sessions"("tenant_id")`,
      `CREATE INDEX IF NOT EXISTS "help_chat_sessions_user_id_idx" ON "help_chat_sessions"("user_id")`,
      `CREATE INDEX IF NOT EXISTS "help_chat_messages_session_id_idx" ON "help_chat_messages"("session_id")`,
      `CREATE UNIQUE INDEX IF NOT EXISTS "help_escalations_session_id_key" ON "help_escalations"("session_id")`,
      `CREATE UNIQUE INDEX IF NOT EXISTS "help_chat_daily_usage_user_id_day_key" ON "help_chat_daily_usage"("user_id", "day")`,
      `DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'help_chat_sessions_tenant_id_fkey') THEN
    ALTER TABLE "help_chat_sessions" ADD CONSTRAINT "help_chat_sessions_tenant_id_fkey"
      FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
  END IF;
END $$`,
      `DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'help_chat_sessions_user_id_fkey') THEN
    ALTER TABLE "help_chat_sessions" ADD CONSTRAINT "help_chat_sessions_user_id_fkey"
      FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
  END IF;
END $$`,
      `DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'help_chat_messages_session_id_fkey') THEN
    ALTER TABLE "help_chat_messages" ADD CONSTRAINT "help_chat_messages_session_id_fkey"
      FOREIGN KEY ("session_id") REFERENCES "help_chat_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
  END IF;
END $$`,
      `DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'help_escalations_session_id_fkey') THEN
    ALTER TABLE "help_escalations" ADD CONSTRAINT "help_escalations_session_id_fkey"
      FOREIGN KEY ("session_id") REFERENCES "help_chat_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
  END IF;
END $$`,
      `DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'help_chat_daily_usage_user_id_fkey') THEN
    ALTER TABLE "help_chat_daily_usage" ADD CONSTRAINT "help_chat_daily_usage_user_id_fkey"
      FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
  END IF;
END $$`,
    ],
    description: 'pgvector help RAG chunks, chat sessions/messages, escalations, daily usage',
  },
  {
    name: '20260514120000_add_password_reset_tokens',
    statements: [
...
END $$`,
  ...
  {
    name: '20260707000000_add_google_calendar_sync',
    statements: [
      ...
      `DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'google_calendar_connections_tenantId_fkey') THEN
    ALTER TABLE "google_calendar_connections" ADD CONSTRAINT "google_calendar_connections_tenantId_fkey"
      FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
  END IF;
END $$`,
      `DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'google_calendar_connections_userId_fkey') THEN
...
END $$`,
      `DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'google_calendar_event_maps_connectionId_fkey') THEN
    ALTER TABLE "google_calendar_event_maps" ADD CONSTRAINT "google_calendar_event_maps_connectionId_fkey"
      FOREIGN KEY ("connectionId") REFERENCES "google_calendar_connections"("id") ON DELETE CASCADE ON UPDATE CASCADE;
  END IF;
END $$`,
      `DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'google_calendar_event_maps_bookingId_fkey') THEN
    ALTER TABLE "google_calendar_event_maps" ADD CONSTRAINT "google_calendar_event_maps_bookingId_fkey"
