#!/bin/bash
# JobDock Database Migration Setup - Final Version
# Uses NodeSource for compatible Node.js on Amazon Linux 2
...
# Install Node.js 16 from NodeSource (compatible with AL2)
echo "📦 Installing Node.js 16 from NodeSource..."
...
mkdir -p ~/jobdock/backend/prisma
cd ~/jobdock/backend
...
echo ""
echo "✅ All done! Your database is ready with all tables created."
echo ""
