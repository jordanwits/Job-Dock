      ...
      <div className="max-w-md w-full bg-primary-dark-secondary rounded-lg shadow-xl p-8 text-center">
        ...
        {showSpinner && !success ? (
          ...
          <div className="space-y-4 text-left">
            <h2 className="text-xl font-semibold text-primary-light text-center">Decline this quote?</h2>
            ...
            <label htmlFor="decline-reason" className="block text-sm text-primary-light/80">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-primary-light">Accept this quote?</h2>
