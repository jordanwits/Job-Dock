export const landingPageContent = {
  ...
  valueProposition: {
    ...
    cards: [
      ...
      },
      {
        title: 'All Connected',
        description:
          'One system for quotes, invoices, scheduling, time tracking, photos, and reports.',
      },
      {
  ...
  problem: {
    ...
    conclusion: {
      ...
      description:
        'Admin creeps into nights and weekends. Things get missed. And nothing feels truly organized.',
    },
  },
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        title: 'Job Logs',
        description:
          'Track time, capture photos, and take notes on jobsites. Stay organized in the field.',
      },
      {
        title: 'Reports',
        description:
          'View and export business reports for employee pay, quotes, invoices, and jobs. Filter by date range.',
      },
    ],
  },
  ...
  howItWorks: {
    ...
    conclusion: ['Everything stays connected.', 'Everything stays visible.'],
  },
  ...
  solution: {
    ...
    benefits: [
      ...
      'Track time, capture photos, and take notes on jobsites',
      'Export reports for employee pay, quotes, invoices, and jobs',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'We make it easy to import your contacts from spreadsheets or CSV files. You can also add clients one at a time as you go — whatever works for your workflow.',
      },
      {
        question: 'How does the booking system work?',
        answer:
          'You control your availability. Clients can request bookings through a link you share, and you approve or adjust them. No more phone tag or double-bookings.',
      },
      {
        question: 'Is my data secure?',
        answer:
          'Absolutely. We use industry-standard encryption and secure hosting on AWS. Your data is backed up regularly and protected with the same security used by major financial institutions.',
      },
      {
