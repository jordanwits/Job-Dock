...
const realJobLogsService = {
  ...
  create: async (data: { title: string; description?: string; location?: string; notes?: string; jobId?: string; contactId?: string; price?: number | null; serviceId?: string; assignedTo?: any; status?: string }) => {
    const response = await apiClient.post('/job-logs', data)
    return response.data
  },

  update: async (id: string, data: Partial<{ title: string; description?: string; location?: string; notes?: string; jobId?: string; contactId?: string; price?: number | null; serviceId?: string; assignedTo?: any; status?: string }>) => {
...
const realBillingService = {
  ...
  cancelAndScheduleDeletion: async () => {
